...
export default function StorySteps({
  ...
  onStep,
  className = '',
  noteLabel = '↳ What the model is doing',
}: Props) {
  ...
  return (
    <section className={className}>
      <div className={`relative rounded-2xl border ${accentBorder} ${accentBg} p-5 mb-3`}>
        ...
        {beat?.llmNote && (
          <p key={`note-${step}`} className="anim-float-in hidden md:block mt-3 text-sm text-paper leading-relaxed border-l-2 border-white/15 pl-3">
